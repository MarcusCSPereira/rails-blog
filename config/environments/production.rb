...
Rails.application.configure do
  ...
  # Railway fornece RAILWAY_PUBLIC_DOMAIN ou você pode definir RAILS_HOST
  config.action_mailer.default_url_options = {
    host: ENV.fetch("RAILS_HOST") { ENV.fetch("RAILWAY_PUBLIC_DOMAIN", "localhost") },
    protocol: "https",
  }
  ...
  # Railway permite qualquer host, mas você pode restringir se necessário
  # config.hosts = [
  #   ENV.fetch("RAILS_HOST", "localhost"),
  #   /.*\.railway\.app/ # Permitir subdomínios do Railway
  # ]
  #
